...
(1a) Exposing users to the puzzling situation by asking them to guess or predict what would happen if air is blown between two sheets of paper and showing them the image with the link: 
     https://drive.google.com/file/d/1A3Pab2nkVJO_hIKK-e_n03GPsUR0XZYJ/view?usp=sharing 
     Ask the users the question: "Will they move further apart or come closer together?" Don't give them the answer straightaway.
...
(2a) Asking the user to guess or predict what would happen if air is blown on top of a single sheet of paper and showing them the image with the link: 
     https://drive.google.com/file/d/1y2vK_uXixjHHXiq8N0modvVJ0krE40tM/view?usp=sharing
